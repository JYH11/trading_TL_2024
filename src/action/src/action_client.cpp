...
int main(int argc, char** argv) {
    ...
    clients.push_back(std::make_shared<ActionClient<interfaces::action::Progress>>("Client1", "progress_action", 10));
    clients.push_back(std::make_shared<ActionClient<interfaces::action::Progress>>("Client2", "progress_action", 20));
    clients.push_back(std::make_shared<ActionClient<interfaces::action::OtherAction>>("Client3", "other_action", 11));
