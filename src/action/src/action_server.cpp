...
#include "interfaces/action/progress.hpp"
#include "interfaces/action/other_action.hpp"
#include <mutex>
#include <memory>
...
public:
    ...
    : Node(name),
      progress_server(rclcpp_action::create_server<interfaces::action::Progress>(
        this,
        "progress_action",
      ...
      other_server(rclcpp_action::create_server<interfaces::action::OtherAction>(
        this,
        "other_action",
...
private:
    rclcpp_action::Server<interfaces::action::Progress>::SharedPtr progress_server;
    rclcpp_action::Server<interfaces::action::OtherAction>::SharedPtr other_server;
    std::mutex mutex_;
    ...
    rclcpp_action::GoalResponse handle_progress_goal(
        ...
        std::shared_ptr<const interfaces::action::Progress::Goal> goal)
    {
    ...
    rclcpp_action::CancelResponse handle_progress_cancel(
        std::shared_ptr<rclcpp_action::ServerGoalHandle<interfaces::action::Progress>> goal_handle)
    {
    ...
    void execute(
        std::shared_ptr<rclcpp_action::ServerGoalHandle<interfaces::action::Progress>> goal_handle)
    {
        auto feedback = std::make_shared<interfaces::action::Progress::Feedback>();
        auto result = std::make_shared<interfaces::action::Progress::Result>();
    ...
    rclcpp_action::GoalResponse handle_other_goal(
        ...
        std::shared_ptr<const interfaces::action::OtherAction::Goal> goal_other)
    {
    ...
    rclcpp_action::CancelResponse handle_other_cancel(
        std::shared_ptr<rclcpp_action::ServerGoalHandle<interfaces::action::OtherAction>>goal_other_handle)
    {
    ...
    void execute_other(
        std::shared_ptr<rclcpp_action::ServerGoalHandle<interfaces::action::OtherAction>> goal_other_handle)
    {
        auto feedback = std::make_shared<interfaces::action::OtherAction::Feedback>();
        auto result = std::make_shared<interfaces::action::OtherAction::Result>();
